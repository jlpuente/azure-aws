...
# @Last modified by:   Daniel Garrido
...
# DGM changed in 2022:     ln = [ln[i[0] - 1] for i in net.getUnconnectedOutLayers()]
...
def main2():
    # load our input image and grab its spatial dimensions
    #image = cv2.imread("./test1.jpg")
    resp = urllib.request.urlopen(request.args.get('image'))
...
# route http posts to this method
# This route receives a binary stream including a jpg image (no forms are used)
